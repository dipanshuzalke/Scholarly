    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] text-center px-4">
        ...
        <p className="text-gray-500 mb-6 max-w-sm">
          You haven’t saved any LinkedIn posts or articles yet. Use this space
          to keep track of professional insights and career-related content.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <p className="text-gray-600 mb-6">
        Save valuable career content, posts, and insights from LinkedIn to grow
