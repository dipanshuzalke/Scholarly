    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] text-center px-4">
        ...
        <p className="text-gray-500 mb-6 max-w-sm">
          You haven’t added any notes yet. Start saving your thoughts,
          summaries, or resources here.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    <>
      ...
      <p className="text-gray-600 mb-6">
        You're notes, summaries, and resources all in one place.
      </p>
      <div className="w-full h-full flex items-start gap-0.5 md:gap-4 flex-wrap">
