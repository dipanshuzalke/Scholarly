    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] text-center px-4">
        ...
        <p className="text-gray-500 mb-6 max-w-sm">
          You haven’t added any YouTube content yet. Save insightful videos,
          podcasts, or lectures to come back to later.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <p className="text-gray-600 mb-6">
        Keep track of your favorite YouTube videos, lectures, or content you
        want to revisit.
      </p>
