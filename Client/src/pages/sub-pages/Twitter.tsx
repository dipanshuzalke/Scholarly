    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] text-center px-4">
        ...
        <p className="text-gray-500 mb-6 max-w-sm">
          You haven’t added any tweets yet. Start saving interesting threads,
          quotes, or ideas from Twitter.
        </p>
      </div>
    );
  }
  return (
    <>
      ...
      <p className="text-gray-600 mb-6">
        Curate and keep track of your favorite tweets, threads, or Twitter
        insights right here.
      </p>
