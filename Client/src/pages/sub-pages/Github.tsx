    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] text-center px-4">
        ...
        <h2 className="text-xl font-semibold text-gray-700 mb-2">
          No GitHub Content Yet
        </h2>
        <p className="text-gray-500 mb-6 max-w-sm">
          You haven’t saved any GitHub repos or gists yet. Start collecting cool
          projects, code snippets, or libraries worth revisiting.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <p className="text-gray-600 mb-6">
        Organize your saved repositories, snippets, and useful developer tools
        from GitHub here.
      </p>
